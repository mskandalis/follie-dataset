...
The resulting FOLLIE dataset preserves all these elements for the converted sentences, in addition to providing logical representations of the sentences. It can therefore be used either for natural language–to–FOL translation tasks or for NLI/RTE tasks using neurosymbolic approaches (i.e., solving NLI by reasoning over FOL formulas).
